                    ...
                    ${pages.map((pageMembers, pageIndex) => `
                        <div class="page-container">
                            <div class="print-page-header">
                                <div class="date-right" style="position: absolute; top: 0; right: 0; width: 170px; text-align: center; line-height: 1.3;">
                                    ${synagogueImg ? `
                                    ...
                                    ` : ''}
                                    <div style="font-size: 11.5px; font-weight: bold; margin-top: 2px;">תאריך עברי: ${todayHebrew}</div>
                                    <div style="font-size: 11.5px; font-weight: bold;">תאריך לועזי: ${todayGregorian}</div>
                                </div>
                                <div class="title-center">
                                    <div class="title">רשימת עליות מלאה</div>
